...
import {EMAIL, TALLY_FORM} from "../utils/constants";
    ...
    <section id="contact" className="py-24 bg-background">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className={`space-y-8`}>
            <div>
              ...
              <p className="text-lg text-muted-foreground test">
                If you have a project in mind, or just want to start a conversation, feel free to reach out.
              </p>
            </div>
          ...
          <div className={`glass-card rounded-3xl p-8 md:p-12 shadow-2xl text-center space-y-6`}>
